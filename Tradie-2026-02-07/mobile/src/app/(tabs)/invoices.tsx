...
export default function InvoicesScreen() {
  ...
  const handleExportCsv = async (preset: DatePreset) => {
    ...
    try {
      ...
      setModal({ title: 'Export Failed', message: 'Could not export invoices. Please try again.', variant: 'error' });
    } finally {
      setExporting(false);
    }
  };
      ...
      {showExportModal && (
        ...
        >
          <Pressable onPress={() => {}} className="bg-[#1E293B] rounded-t-2xl border-t border-[#334155] p-4 pb-8">
            <Text className="text-white font-bold text-base mb-4 text-center">Export Invoices</Text>
            <View className="gap-2">
