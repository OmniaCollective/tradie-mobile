...
export default function CustomerBookingScreen() {
  ...
  const { calculateQuote, addCustomer, addJob, pricingPresets, customers } = useTradeStore();

  const jobOptions: JobOption[] = pricingPresets
  ...
  const handleConfirmBooking = async () => {
    ...
    addJob({
      customerId,
      type: selectedJob,
      description: description || jobOptions.find(j => j.type === selectedJob)?.label || '',
      urgency,
      status: 'QUOTED',
      quote: {
        ...quote,
                ...
                {jobOptions.map((option) => (
                  ...
                  >
                    ...
                    <View className="flex-1">
                      ...
                      <Text className="text-slate-400 text-sm mt-0.5">Tap to select</Text>
                    </View>
                    {selectedJob === option.type && (
            ...
            <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
              ...
              <View className="bg-[#1E293B] rounded-xl border border-[#334155] p-4 mb-4">
                ...
                <Text className="text-slate-400 text-sm mt-1">
                  {description || selectedJobOption?.label}
                </Text>
                {urgency !== 'standard' && (
        ...
        return (
          ...
          >
            ...
            <Text className="text-slate-400 text-center px-8 mb-8">
              We've received your booking request. We'll review and confirm your appointment shortly.
            </Text>
            <View className="bg-[#1E293B] rounded-xl p-4 w-full max-w-[300px] mb-6">
            ...
            <Pressable
              ...
              className="bg-[#14B8A6] rounded-xl px-8 py-4 active:opacity-80"
            >
